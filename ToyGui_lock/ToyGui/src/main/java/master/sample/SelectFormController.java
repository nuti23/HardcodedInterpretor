...
import master.model.statement.Lock.LockStatement;
import master.model.statement.Lock.NewLockStatement;
import master.model.statement.Lock.UnlockStatement;
...
public class SelectFormController implements Initializable {
    ...
    private void buildProgramStatements() {
        ...
        IStatement ex20 = new CompoundStatement(new NewStatement("v1", new ConstantExpression(20)),

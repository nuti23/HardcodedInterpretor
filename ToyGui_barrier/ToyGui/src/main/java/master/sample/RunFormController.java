...
public class RunFormController implements Initializable {
    ...
    public void setController(Controller controller) {
        ...
        programStateListView.getSelectionModel().select(0);
        programStateListView.getFocusModel().focus(0);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        executeOneStepButton.setOnAction(actionEvent -> {
            executeOneStep(actionEvent);
        });

    }

    private void executeOneStep(ActionEvent actionEvent) {
        if (controller == null) {

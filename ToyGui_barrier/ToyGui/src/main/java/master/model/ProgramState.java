...
public class ProgramState {
    ...
    public ProgramState(MyStack<IStatement> programStateMyStack, MyIDictionary<String,
            Integer> symbolTable, List<Integer> outputList, IStatement originalProgram,
                        MyIDictionary<Integer, MyFilePair> fileTable, MyIDictionary<Integer,
                        Integer> heap, Integer id, MyIDictionary<Integer, Pair<Integer, List<Integer>>> barrierTable) {

...
import master.model.statement.Semaphore.AcquireStatement;
import master.model.statement.Semaphore.NewSemaphoreStatement;
import master.model.statement.Semaphore.ReleaseStatement;
...
public class SelectFormController implements Initializable {
    ...
    private void buildProgramStatements() {
        ...
        IStatement ex20 = new CompoundStatement(new NewSemaphoreStatement("v", new ConstantExpression(2)),
                new CompoundStatement(
                        new ForkStatement(
                                new CompoundStatement(
        ...
        programStatements = new ArrayList<>(Arrays.asList(ex0, ex1, ex2, ex3, ex4, ex5, ex6, ex7, ex8, ex9, ex10, ex11, ex12, ex13, ex14, ex15, ex16, ex17, ex18, ex19, ex20, ex21));
    }
